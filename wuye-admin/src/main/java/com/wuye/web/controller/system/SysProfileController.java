...
import com.wuye.common.utils.file.FileUploadUtils;
import com.wuye.common.utils.file.FileUtils;
import com.wuye.common.utils.file.MimeTypeUtils;
import com.wuye.framework.web.service.TokenService;
...
public class SysProfileController extends BaseController
{
    ...
    public AjaxResult avatar(@RequestParam("avatarfile") MultipartFile file) throws Exception
    {
        ...
        {
            LoginUser loginUser = getLoginUser();
            String avatar = FileUploadUtils.upload(WuYeConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION, true);
            if (userService.updateUserAvatar(loginUser.getUserId(), avatar))
            {
                String oldAvatar = loginUser.getUser().getAvatar();
                if (StringUtils.isNotEmpty(oldAvatar))
                {
                    FileUtils.deleteFile(WuYeConfig.getProfile() + FileUtils.stripPrefix(oldAvatar));
                }
