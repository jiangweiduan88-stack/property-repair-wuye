        ...
        <el-form v-show="currentTab === 'form'" label-width="90px" label-position="top">
          ...
          <el-form-item label="表单尺寸">
            <el-radio-group v-model="formConf.size">
              <el-radio-button label="large" value="较大">较大</el-radio-button>
              <el-radio-button label="default" value="默认">默认</el-radio-button>
              <el-radio-button label="small" value="较小">较小</el-radio-button>
            </el-radio-group>
          </el-form-item>
          <el-form-item label="标签对齐">
            <el-radio-group v-model="formConf.labelPosition">
              <el-radio-button label="left" value="左对齐">左对齐</el-radio-button>
              <el-radio-button label="right" value="右对齐">右对齐</el-radio-button>
              <el-radio-button label="top" value="顶部对齐">顶部对齐</el-radio-button>
            </el-radio-group>
          </el-form-item>
