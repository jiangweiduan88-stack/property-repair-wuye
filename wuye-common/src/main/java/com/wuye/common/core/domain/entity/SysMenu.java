...
public class SysMenu extends BaseEntity
{
    ...
    @Size(min = 0, max = 200, message = "Route path length cannot exceed 200 characters")
    ...
    @Size(min = 0, max = 255, message = "Component path length cannot exceed 255 characters")
